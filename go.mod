...
replace github.com/libp2p/go-libp2p v0.19.2 => github.com/libp2p/go-libp2p v0.9.2

replace github.com/prometheus/client_golang v1.15.1 => github.com/prometheus/client_golang v1.5.0

replace github.com/tidwall/gjson v1.9.4 => github.com/tidwall/gjson v1.6.8

replace github.com/flynn/noise v1.0.0 => github.com/flynn/noise v0.0.0-20180327030543-2492fe189ae6
