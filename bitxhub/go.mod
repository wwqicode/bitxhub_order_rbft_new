...
require (
	...
	github.com/hyperledger/fabric v2.2.12+incompatible // indirect
...
replace (
	...
	github.com/flynn/noise v1.0.0 => github.com/flynn/noise v0.0.0-20180327030543-2492fe189ae6

	github.com/golang/protobuf => github.com/golang/protobuf v1.3.2

	github.com/hyperledger/fabric => github.com/hyperledger/fabric v2.0.1+incompatible

	github.com/libp2p/go-libp2p v0.19.2 => github.com/libp2p/go-libp2p v0.9.2

	github.com/mitchellh/mapstructure v1.4.1 => github.com/mitchellh/mapstructure v1.1.2

	github.com/prometheus/client_golang v1.15.1 => github.com/prometheus/client_golang v1.5.0

	github.com/spf13/afero v1.5.1 => github.com/spf13/afero v1.1.2

	github.com/spf13/jwalterweatherman v1.1.0 => github.com/spf13/jwalterweatherman v1.0.0

	github.com/spf13/viper => github.com/spf13/viper v1.7.1

	github.com/tidwall/gjson v1.9.4 => github.com/tidwall/gjson v1.6.8

	golang.org/x/net => golang.org/x/net v0.0.0-20210220033124-5f55cee0dc0d
	...
	golang.org/x/text v0.3.5 => golang.org/x/text v0.3.4
	...
	gopkg.in/ini.v1 v1.62.0 => gopkg.in/ini.v1 v1.51.0
